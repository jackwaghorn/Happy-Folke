...
<template>
  <main class="relative w-full min-h-full bg-off-white h-full z-1">
    <section class="w-full pt-30 md:pt-40">
      <div class="md:mx-50 p-4 grid md:grid-cols-2 gap-12">
        <div class="flex flex-col gap-6 items-center md:items-start justify-center md:justify-start">
          <h2 class="text-brown text-center md:text-start text-large-2 font-bold">{{contact.title}}</h2>
        ...
        <div class="max-w-xl mx-auto p-0 md:p-6 md:pt-4">
          <form class="space-y-3">
            ...
            <div class="flex w-full justify-end">
              <button
                type="submit"
                class="bg-yellow text-brown font-bold rounded-full px-5 py-3 transition"
              >
                Send Message
              </button>
            </div>
